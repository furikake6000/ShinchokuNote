...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'get master_user_token and secret' do
    ...
    login_as_noritama
    assert_equal master_user_token, credentials_wrap('twitter_test_fixture', 'noritama_token')
    assert_equal master_user_secret, credentials_wrap('twitter_test_fixture', 'noritama_secret')
  ...
  test 'get current_user_token and secret' do
    ...
    # Token and secret with logging in
    login_as_noritama
    assert_equal current_user_token, credentials_wrap('twitter_test_fixture', 'noritama_token')
    assert_equal current_user_secret, credentials_wrap('twitter_test_fixture', 'noritama_secret')
    # Token and secret with logging in with two accounts
    login_as_okaka
    assert_equal current_user_token, credentials_wrap('twitter_test_fixture', 'okaka_token')
    assert_equal current_user_secret, credentials_wrap('twitter_test_fixture', 'okaka_secret')
  end
