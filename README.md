...
+ 進捗どうですかの種類を増やしました。製作者さんに、より率直に気持ちを伝えられるようになりました。
+ 各ノートの「進」ボタンにカーソルを合わせる（スマートフォンは長押し）と、新しく追加された項目が表示されます。
+ 「好き！」「おつかれさま」「応援してます」「いつまでも待ちます」の四種類を追加しました

### ver 1.0.2

2018/09/02

+ R18設定の投稿が「みんなの進捗」に表示されるバグを修正
